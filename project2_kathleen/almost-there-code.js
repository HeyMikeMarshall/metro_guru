...
d3.json(url).then(function (data) {
    ...
    for (var i = 0; i < data.BusPositions.length; i++) {
        ...
        stationCount[stationCode]++;
        // Create a new marker with the appropriate icon and coordinates
        // var newMarker = L.marker([bus.lat, bus.lon], {
        //     icon: icons[stationCode]
        var newMarker = L.marker([bus.Lat, bus.Lon], { icon: chooseMarker(bus.RouteID) })
            .bindPopup("<h1>" + "Route:" + bus.RouteID + "   " + "(" + "Bus No:" + bus.VehicleID + ")" + "</h1>")
            .addTo(myMap(layers[stationCode]));
    

// Add the new marker to the appropriate layer
// newMarker.addTo(layers[stationCode]);
...
function updateLegend(time, stationCount) {
    document.querySelector(".legend").innerHTML = [
        ...
        "<p class='Red Line'>Red Line: " + stationCount.RED_LINE + "</p>",
        "<p class='Blue Line'>Blue Line: " + stationCount.BLUE_LINE + "</p>",
        "<p class='Silver Line'>Silver Line: " + stationCount.SILVER_LINE + "</p>",
        "<p class='Yellow Line'>Yellow Line: " + stationCount.YELLOW_LINE + "</p>",
        "<p class='Green Line'>Green Line: " + stationCount.GREEN_LINE + "</p>",
        "<p class='Orange Line'>Green Line: " + stationCount.ORANGE_LINE + "</p>",
        "<p class='Black Line'>Green Line: " + stationCount.BLACK_LINE + "</p>"
    ].join("");
}
